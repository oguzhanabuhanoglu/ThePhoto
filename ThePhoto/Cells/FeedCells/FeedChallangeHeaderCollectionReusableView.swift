//
//  FeedChallangeHeaderCollectionReusableView.swift
//  ThePhoto
//
...
protocol FeedChallangeHeaderCollectionReusableViewDelegate : AnyObject {
    func didTapCameraButton()
}

class FeedChallangeHeaderCollectionReusableView: UICollectionReusableView {
    
    static let identifier = "FeedChallangeHeaderCollectionReusableView"
    
    weak var delegate : FeedChallangeHeaderCollectionReusableViewDelegate?
